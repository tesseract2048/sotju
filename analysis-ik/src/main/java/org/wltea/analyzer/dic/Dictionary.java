/**
 * IK 中文分词 版本 5.0 IK Analyzer release 5.0 Licensed to the Apache Software
...
public class Dictionary {
    ...
    public Hit matchInMainDict(char[] charArray, int begin, int length) {
        return singleton._MainDict.match(String.valueOf(charArray)
                .toLowerCase().toCharArray(), begin, length);
    }
    ...
    public Hit matchInQuantifierDict(char[] charArray, int begin, int length) {
        return singleton._QuantifierDict.match(String.valueOf(charArray)
                .toLowerCase().toCharArray(), begin, length);
    }
    ...
    public boolean isStopWord(char[] charArray, int begin, int length) {
        return singleton._StopWords.match(
                String.valueOf(charArray).toLowerCase().toCharArray(), begin,
                length).isMatch();
    }
    ...
    private void loadMainDict() {
        ...
        InputStream is = null;
        try {
            is = configuration.getResourceAsStream(Dictionary.PATH_DIC_MAIN);
    ...
    private void loadExtDict() {
        ...
        if (extDictFiles != null) {
            ...
            for (String extDictName: extDictFiles) {
                ...
                try {
                    is = configuration.getResourceAsStream(extDictName);
                } catch (FileNotFoundException e) {
                    logger.error("ik-analyzer", e);
                }
    ...
    private void loadStopWordDict() {
        ...
        InputStream is = null;
        try {
            is = configuration.getResourceAsStream(Dictionary.PATH_DIC_STOP);
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            do {
                theWord = br.readLine();
                if (theWord != null && !"".equals(theWord.trim())) {
                    _StopWords.fillSegment(theWord.trim().toLowerCase()
                            .toCharArray());
                }
            } while (theWord != null);
        ...
        if (extStopWordDictFiles != null) {
            ...
            for (String extStopWordDictName: extStopWordDictFiles) {
                ...
                // 读取扩展词典文件
                try {
                    is = configuration.getResourceAsStream(extStopWordDictName);
                } catch (FileNotFoundException e) {
                    logger.error("ik-analyzer", e);
                }
                // 如果找不到扩展的字典，则忽略
    ...
    private void loadQuantifierDict() {
        ...
        InputStream is = null;
        try {
            is = configuration.getResourceAsStream(Dictionary.PATH_DIC_QUANTIFIER);
        } catch (FileNotFoundException e) {
            logger.error("ik-analyzer", e);
        }
        try {
    ...
    private void loadSurnameDict() {
        ...
        InputStream is = null;
        try {
            is = configuration.getResourceAsStream(Dictionary.PATH_DIC_SURNAME);
        } catch (FileNotFoundException e) {
            logger.error("ik-analyzer", e);
        }
        if (is == null) {
    ...
    private void loadSuffixDict() {
        ...
        InputStream is = null;
        try {
            is = configuration.getResourceAsStream(Dictionary.PATH_DIC_SUFFIX);
        } catch (FileNotFoundException e) {
            logger.error("ik-analyzer", e);
        }
        if (is == null) {
    ...
    private void loadPrepDict() {
        ...
        InputStream is = null;
        try {
            is = configuration.getResourceAsStream(Dictionary.PATH_DIC_PREP);
        } catch (FileNotFoundException e) {
            logger.error("ik-analyzer", e);
        }
        if (is == null) {
