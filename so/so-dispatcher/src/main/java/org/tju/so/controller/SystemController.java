...
public class SystemController {
    ...
    @RequestMapping(value = "/schema/reload", produces = "application/json; charset=utf-8")
    @ResponseBody
    public String schemaReload(HttpServletRequest req) throws Exception {
        schemaHolder.flush();
        return "{\"success\":true}";
    }

    @RequestMapping(value = "/site/reload", produces = "application/json; charset=utf-8")
    @ResponseBody
    public String siteReload(HttpServletRequest req) throws Exception {
        siteHolder.flush();
        return "{\"success\":true}";
    }
