...
/**
 * <p>
 * Handles encoding and decoding of Strings, Integers, Lists and Maps
 * (dictionaries) from/into their respective Bencode variants through static
 * methods. Does not particularly require instantiation.
 * 
 * @author bo
 */
...
public class Bencode {
     ...
     * 
     * @param arg
     *            the general Object to bencode.
     * @return returns a String with the bencoded data if the object can be
     *         encoded (ie, is one of String, Integer, Long, List or Map.)
     *         Throws an exception if the object cannot be bencoded.
     * @throws java.lang.Exception
     *             if the argument is not an instance of either String, Integer,
     *             Long, List or Map.
     */
    private static String encode(Object arg) throws Exception {
        if (java.lang.String.class.isInstance(arg)) {
            ...
            throw new Exception("Object class not supported. "
     ...
     * 
     * @param arg
     *            the string to be bencoded
     * @return a string containing the length of the argument given, followed by
     *         a colon and then the original argument arg. For example, the
     *         bencoded version of "cat" is "3:cat".
     */
     ...
     * 
     * @param arg
     *            the Integer to be bencoded
     * @return a string containing the bencoded integer given in arg,
     *         represented by an 'i' followed by the number in base 10 and
     *         finished with an 'e'. Does not return leading zeroes or i-0e.
     */
     ...
     * @param arg
     *            the List to bencode
     * @return a string containing the bencoded list if the list contains only
     *         objects that can be bencoded
     * @throws java.lang.Exception
     ...
     * @throws java.lang.Exception
     *             if an element of the map cannot be bencoded or if the keys
    ...
    public static Map decode(byte[] data) throws Exception {
     ...
     * @throws java.lang.Exception
     *             if the InputStream contains malformed bencoded data or throws
     *             an I/O error.
     */
    @SuppressWarnings("unchecked")
     ...
     * 
     * @param stream
     *            the input stream containing the bencoded dictionary.
     * @return a Map containing the decoded contents of the bencoded dictionary.
     * @throws java.lang.Exception
     *             if the dictionary ended unexpectedly, any key of the
     *             dictionary was not a string or the contents of the dictionary
     *             are malformed.
     */
    @SuppressWarnings("unchecked")
        ...
        try {
            ...
            while (charByte != 'e') {
                ...
                if (Character.isDigit(charByte)) {
                    ...
                    // key not a string?
                    throw new Exception(
                            "Key in bencoded dictionary not a string?");
                }
                ...
                if ((readByte = stream.read()) != -1) {
                    ...
                    throw new Exception(
                            "Missing a value in bencoded dictionary?");
                }
     ...
     * @throws java.lang.Exception
     *             if the list ends unexpectedly, or if the content is
     *             malformed.
     */
    @SuppressWarnings("unchecked")
     ...
     * 
     * @param stream
     *            the input stream to decode the integer from.
     * @return a Long representing the bencoded integer in the input stream.
     * @throws java.lang.Exception
     *             if the Integer ended unexpectedly, contains non-number data
     *             or due to problems converting to Long.
     */
     ...
     * 
     * @param firstLengthDigit
     *            the first digit of the length parameter, used since we cannot
     *            easily rewind the input stream, and marking may not be
     *            available (I haven't tested this)
     * @param stream
     *            the input stream to parse the string from
     * @return a String representing the bencoded string given in the input
     *         stream
     * @throws java.lang.Exception
     */
    private static String decodeString(char firstLengthDigit, InputStream stream)
            throws Exception {
